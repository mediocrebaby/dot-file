...
6. **Capture the answer, then hand off.** Record the question, observed verdict, tested scenarios, limitations and artifact path. If the result establishes a durable decision, follow [decision-notes](../decision-notes/SKILL.md); a successful prototype is not an implemented production feature. Do not promote it until the user authorizes implementation and production checks pass.
