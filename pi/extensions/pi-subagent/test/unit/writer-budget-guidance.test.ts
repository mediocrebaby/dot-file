...
describe("writer budget guidance", () => {
	it("keeps hard turn and tool caps off mutation-capable agents", () => {
		const readme = readProjectFile("README.md");
		const skillGuidance = readProjectFile("skills/pi-subagents/references/constraints-and-recipes.md");

		for (const text of [readme, skillGuidance]) {
