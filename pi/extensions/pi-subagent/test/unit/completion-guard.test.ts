...
test("explicit review-only tasks with bash available do not require mutation", () => {
	const task = "Review prep findings and recommend what to implement with playbooks. Return findings only; do not edit files.";
	const result = evaluateCompletionMutationGuard({
		agent: "oracle",
		task,
...
test("task wording distinguishes read-only, mutation, and framework output instructions", () => {
...
test("implementation verbs win over investigative wording and scoped prohibitions", () => {
