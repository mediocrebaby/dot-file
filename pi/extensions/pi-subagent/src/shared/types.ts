...
export interface ExtensionConfig {
	...
	/** Show the under-editor async runs widget. Defaults to false. */
	asyncWidget?: boolean;
	...
	/** Prevent future writes to project-local .pi-subagents directories. This silently disables artifacts and redirects operational state outside the project. */
