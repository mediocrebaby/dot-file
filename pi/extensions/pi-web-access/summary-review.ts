...
async function resolveSummaryModelCandidates(
...
): Promise<{ candidates: Array<{ model: Model<Api>; apiKey: string; headers?: Record<string, string | null> }>; errors: string[] }> {
	...
	const candidates: Array<{ model: Model<Api>; apiKey: string; headers?: Record<string, string | null> }> = [];
	const errors: string[] = [];
