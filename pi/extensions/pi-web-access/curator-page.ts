...
export function generateCuratorPage(
	...
	const inlineData = safeInlineJSON({ queries, sessionToken, timeout, defaultProvider, summaryModels, defaultSummaryModel });
...
const SCRIPT = `(function() {
  ...
  var initialDefaultProvider = typeof DATA.defaultProvider === "string" && DATA.defaultProvider ? DATA.defaultProvider : "duckduckgo";
  ...
  addSearchInput.addEventListener("keydown", function(e) {
    ...
    var displayProvider = initialDefaultProvider;
